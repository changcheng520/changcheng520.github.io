...
var MyrootPath_Temp="/demo/d-s-skin-demo/_theme18/"; //网站绝对路径，安装时系统自动修改，如果自己更换，请填写您安装程序的根目录，比如  /blog/ 
...
/*
 - Project:middleBoxButton
*/

$.fn.middleBoxButton = function(wl,distance) {
	var divHeight = 0, divWidth = 0;
	$(this).each(function() {

		$wl = $(".widget-button");
		divHeight = $(this).height() + parseInt($(this).css("padding-top")) + parseInt($(this).css("padding-bottom"));
		divWidth = $(this).width() + parseInt($(this).css("padding-left")) + parseInt($(this).css("padding-right"));
		$wl.css({"margin-top":(divHeight / 2) - parseInt(distance) + "px","margin-left":(divWidth / 2) + "px"});
...
$(document).ready(function(){  
	...
	$("#temp_top").css("margin-top","-30px");
	$("body").prepend("<div id='loadibgShow'></div>");
	$("#container").delay(1000).fadeIn(200); 
	$("#temp_top").delay(1100).animate({marginTop:0}, 400); 
	...
	$('.image-list img,.article-post img,.post-content img,.BoxFrame img').each(function() {
