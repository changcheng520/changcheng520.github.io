...
var MyrootPath_Temp="/demo/d-s-skin-demo/_theme21/"; //网站绝对路径，安装时系统自动修改，如果自己更换，请填写您安装程序的根目录，比如  /blog/ 
...
$(document).ready(function(){  
   ...
   $("#mainNav li").addClass("navDefault");
	...
	//图片加载
	$('.portfolio-box img,.article-post img,.post-content img').each(function() {
